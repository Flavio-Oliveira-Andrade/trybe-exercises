...
## Multer
Você ja utilizou outros momentos o ```Body-Parser``` para tratar dados no corpo da request. hoje voce vai utilizar o `multer` . a funcionalidade dos dois e , em suma , a mesma : interpretar dados enviados do body da requisição
...
Podemos passar um erro no primeiro parâmetro caso não seja desejado prosseguir com o armazenamento do arquivo.
...
Melhor ainda, você pode modificar esse script para pedir que a pessoa usuária digite na linha de comando o nome do arquivo que quer fazer upload. 😉