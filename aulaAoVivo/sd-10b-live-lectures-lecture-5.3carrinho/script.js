window.onload = function () {
  ...
  button.addEventListener('click', function () {
    ...
    car3.style.marginLeft = parseInt(car3.style.marginLeft) + (Math.random() * 100) + 'px';

    if (parseInt(car1.style.marginLeft) > window.innerWidth) {
      alert('Carro VERMELHO ganhou!');
      resetCars(car1, car2, car3);
    }
    ...
    if (parseInt(car3.style.marginLeft) > window.innerWidth) {
      alert('Carro AMARELO ganhou!');
      resetCars(car1, car2, car3);
    }
...
function resetCars(car1, car2 , car3) {
  car1.style.marginLeft = '0px';
  car2.style.marginLeft = '0px';
  car3.style.marginLeft = '0px';
}